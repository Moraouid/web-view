package com.saidweb.webviewpro.webview;
...
public class AdvancedWebView extends WebView {
	...
	protected static final String[] ALTERNATIVE_BROWSERS = new String[] { "com.brave.browser","org.mozilla.firefox", "com.android.chrome", "com.opera.browser", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.browser.beta" };
...
//			}
	...
	public static class Browsers {
		...
		public static String getAlternative(final Context context) {
			...
			@SuppressLint("QueryPermissionsNeeded") final List<ApplicationInfo> apps = context.getPackageManager().getInstalledApplications(PackageManager.GET_META_DATA);
